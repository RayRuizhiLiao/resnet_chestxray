...
class ResNet6_2_1(nn.Module):
    ...
    def __init__(self, block, blocks_per_layers, output_channels=4, 
        ...
        """ Input batch_sizex256x256x1          ->
            ...
            fc layer batch_sizexoutput_channelsx1
        """
        super(ResNet6_2_1, self).__init__()
...
def build_resnet6_2_1(block=BasicBlock, blocks_per_layers=[2, 2, 2, 2, 2, 2], 
                      pretrained=False, pretrained_model_path=None, **kwargs):
    model = ResNet6_2_1(block, blocks_per_layers, **kwargs)
    if pretrained:
        model = model.from_pretrained(pretrained_model_path, block, blocks_per_layers, **kwargs)
    return model